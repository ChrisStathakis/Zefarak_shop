    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, validators=[cart.validators.validate_positive_decimal])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attributes', models.ManyToManyField(to='catalogue.Attribute')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
